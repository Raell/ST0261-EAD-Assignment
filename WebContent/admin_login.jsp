...
<body>
	...
	<div class="span5 container well">
		<form action="adminVerifyLogin.jsp" method="post">
			<fieldset>
				<h2>Administrator Login</h2>
				<label>Username</label> <input class="span5" type="text"
					name="username" placeholder="Enter Username" required> <label>Password</label>
		...
		<a href="admin_reset_password.jsp" style="text-decoration: none;">
			<button class="btn btn-large btn-block btn-warning"
				style="margin-bottom: 10px; margin-top: -20px;">
				Forgot Password <i class="icon-exclamation-sign icon-white"></i>
			</button>
		</a>
	...
	<script type="text/javascript">
		window.jQuery
				|| document
						.write('<script src="js/vendor/jquery-1.9.1.js"><\/script>')
	</script>
